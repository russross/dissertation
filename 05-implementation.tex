...
At a minimum, the storage system could be completed with a centralized manager that periodically queried each server 
...
\end{tabular}
\end{center}
\caption{The messages in the envoy service protocol. The first five support the major state management operations, while the remainder }
