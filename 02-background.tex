...
These systems are all complementary to the goals of Envoy. Indeed, the Envoy prototype uses a primitive and under-specified object-storage layer on the assumption that a production system would be built using a direct application of much of the research described here. Envoy is designed to assume a reliable and performant storage layer, and builds a complete distributed file system above it.
